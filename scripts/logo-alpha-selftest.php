...
$fileName = 'starlight_unit_studios_logo_transparent_v030.png';
...
fwrite(STDOUT, "Logo-Selftest OK: RGBA-Transparenz und neuer Assetpfad aktiv, {$size[0]}x{$size[1]} Pixel.\n");
